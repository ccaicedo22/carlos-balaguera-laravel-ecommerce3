        ...
        <div class="col-lg-8 mb-4 mb-lg-0">
          ...
          <div class="bg-light px-4 py-3">
            <div class="row align-items-center text-center">
              ...
              <div class="col-md-6 text-md-right"><a class="btn btn-outline-dark btn-sm" href="{{route('pedido.index')}}">Procceed to checkout<i class="fas fa-long-arrow-alt-right ml-2"></i></a></div>
            </div>
          </div>
        </div>
        <!-- ORDER TOTAL-->
